...
| `notes/` | Raw working notes: `obsidian/` (decisions log, experiments log, fragilities), `claude-specs/` (control redesign + altitude ladder specs, protocol notes), the original competition strategy. `docs/` is the curated form of this material. | Distilled into `docs/`. |
