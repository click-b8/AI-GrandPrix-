...
4. **Freeze-and-guard beats tune-and-hope.** Validated behavior became untouchable (bit-for-bit default-off tests, ~530 total). Every regression this campaign suffered came from something *not yet* frozen.
